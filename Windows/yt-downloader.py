...
def download_engine():
    ...
    if convert == ".mp3" or convert == ".wav":
        ...
        dwn_video = video.streams.first().download(temp)
        #get the Video
...
class user_interface:
    def __init__(self, master=None):
        ...
        self.url_label.place(anchor='nw', x='25', y='90')
        ...
        self.dir_label.place(anchor='nw', x='25', y='190')
        ...
        self.format_label.place(anchor='nw', x='70', y='290')
        ...
        self.tittle_down.place(anchor='nw', x='200', y='40')
        ...
        self.title.configure(background='#f0f0f0', font='{Ubuntu Condensed} 14 {}', foreground='#000000', text='YOUTUBE')
        self.title.place(anchor='nw', x='200', y='20')
        ...
        self.lab.configure(background='#f0f0f0', height='60', width='60')
        self.lab.place(x=130, y=15)
